    ...
    <section className="md:mt-40 mt-20">
        ...
        <div className=" text-white min-h-screen p-4 md:mb-48 mb-24">
            <div className="flex justify-between mb-8  bg-slate-800 rounded-xl">
                <button
                className={`md:py-4 px-6 py-3 md:w-48 w-full md:rounded-lg rounded-l-lg font-semibold transition ${
                    showExperience ? "bg-cyan-500 text-slate-900" : "bg-slate-700 text-gray-300"
                }`}
                ...
                <button
                className={`md:py-4 px-6 py-3 md:w-48 w-full md:rounded-lg rounded-r-lg font-semibold transition ${
                    !showExperience ? "bg-cyan-500 text-slate-900" : "bg-slate-700 text-gray-300"
                }`}
            ...
            <div className="relative border-l-4 border-cyan-500 pl-6 space-y-6">
                ...
                <div key={index} className="relative bg-slate-800 p-6 rounded-lg shadow-lg">
