...
const Navbar = () => {
    ...
    return (
        <nav className='md:px-32 px-4 py-4 top-0 left-0 sticky z-[100] bg-gray-900 text-gray-200 opacity-80 shadow-xl'>
            ...
            {/* Mobile Menu */}
            <div ref={menuRef} className={`${open ? "right-0" : "right-[-100%]"} sm:hidden fixed top-0 bottom-0 space-y-8 py-6 px-8 w-[85%] h-screen duration-300 ease-in-out bg-slate-900 opacity-100`}>
